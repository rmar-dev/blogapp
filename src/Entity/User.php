...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\TenantUserServiceProvider", mappedBy="user_id")
     */
    private $connetcServiceProvider;
    ...
    public function __construct()
    {
        ...
        $this->connetcServiceProvider = new ArrayCollection();
    }
     ...
     */
    public function getServiceProvider(): ArrayCollection
    {
        return $this->connetcServiceProvider;
    }
